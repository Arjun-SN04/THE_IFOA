// Comprehensive list of all world countries and territories with ISO codes and dial codes
export const COUNTRIES = [
  ...
  { code: 'VG', name: 'British Virgin Islands', dial_code: '+1284' },
  ...
  { code: 'DO', name: 'Dominican Republic', dial_code: '+1809' },
  ...
  { code: 'PR', name: 'Puerto Rico', dial_code: '+1787' },
  ...
  { code: 'VC', name: 'Saint Vincent and the Grenadines', dial_code: '+1784' },
  ...
  { code: 'SX', name: 'Sint Maarten', dial_code: '+1721' },
...
/**
 * Returns flag emoji for any ISO 3166-1 alpha-2 code
 */
